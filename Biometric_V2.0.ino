...
#include <LCD_I2C.h> //lcd header file
LCD_I2C lcd(0x3F);
...
lcd.clear();
delay(100);
lcd.print("Fasonranti Leke");
lcd.setCursor(0,1);
lcd.print(" AUO17EC1246 ");
delay(2000);
...
slave.print("a");
slave.print("Start Time: ");
slave.print(now.hour(), DEC);
slave.print(':');
slave.print(now.minute(), DEC);
slave.print(':');
slave.print(now.second(), DEC);
slave.print(" ");
slave.print("Date: ");
slave.print(now.day(), DEC);
slave.print('/');
slave.print(now.month(), DEC);
slave.print('/');
slave.println(now.year(), DEC);
}
...
{
id=count;
Serial.println("Enter your Name, Matric No and Course starting with a 'b' ");
/**
 * while(1){
